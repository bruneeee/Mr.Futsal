...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_PARTITA = "CREATE TABLE IF NOT EXISTS partita     (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL UNIQUE, id_squadraLocali INT NOT NULL,id_squadraOspiti INT NOT NULL,data DATETIME NOT NULL,nomeArbitro VARCHAR(45) NULL);";
    ...
    private static final String TABLE_CONVOCATI = "CREATE TABLE IF NOT EXISTS convocati (id_giocatore INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL UNIQUE,id_partita INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL UNIQUE)";
